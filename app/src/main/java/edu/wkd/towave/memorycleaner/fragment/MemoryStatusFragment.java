package edu.wkd.towave.memorycleaner.fragment;
 ...
 * {@link MemoryStatusFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MemoryStatusFragment#newInstance} factory method to
...
public class MemoryStatusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_memory_status, null);
        context = getActivity();
